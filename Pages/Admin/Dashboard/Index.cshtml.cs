...
namespace WebRazor.Pages.Admin.Dashboard
{
    public class IndexModel : PageModel
    {
        ...
        public IActionResult OnGet()
        {
            ...
            var y = (from d in db.Orders select d.OrderDate.Value.Year);

            years = y.Distinct().ToList();
            decimal wsales = 0;
            ...
            Dictionary<int, decimal> longs;
            if (yearChoose > 0)
            {
                longs = db.Orders.Include(o => o.OrderDetails).Where(o => o.OrderDate.Value.Year == yearChoose).ToList()
                .GroupBy(o => o.OrderDate.Value.Month)
                .ToDictionary(e => e.Key, e => e.Sum(e => e.OrderDetails.Sum(e => e.UnitPrice * e.Quantity * (1 - (decimal)e.Discount))));
            }
            else
            {
                longs = db.Orders.Include(o => o.OrderDetails).ToList()
                .GroupBy(o => o.OrderDate.Value.Month)
                .ToDictionary(e => e.Key, e => e.Sum(e => e.OrderDetails.Sum(e => e.UnitPrice * e.Quantity * (1 - (decimal)e.Discount))));
            }
